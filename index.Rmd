...
All the software required to run this course is accessible through the online learning environment, therefore you do not need to run the following sections.  If you would like to install the software used in this course on your personal computer please follow the instructions below:
